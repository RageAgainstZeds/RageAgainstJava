...
public class Main {
    static final String DB_CONNECTION = "jdbc:mysql://localhost:3306/java_pro";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            List<Client> getIDlistDao = dao.findById(Client.class, 3);

            dao.update(list.get(0), "name", "bla-bla-bla");
